summary: How to Create a Leaderboard in Android SDK
...
In order to use Nudge Experience you have to Install Nudge Core and the Experience (in this case Leaderboard SDK). In order to add the below dependencies, follow the below steps.
...
```
```kotlin
implementation ("com.nudgenow.nudge_android:leaderboard:1.0.0")
```
...
Duration: 1
### Congrats
You have sucessfully added the Leaderboard SDK to you App.